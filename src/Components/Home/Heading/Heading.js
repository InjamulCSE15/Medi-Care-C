            ...
            <div class="container row g-3">
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <h5 class="text-white mb-5">We provide high solution for your health. <br/>Come to us for Best Doctor & Best Care.</h5>
                        <button type="button" class="mt-3 btn btn-outline-light text-uppercase"><a href="#services" className="get-button">Get Appointment</a></button>
                    </div>
                </div>
                <div class="col-md-6">
